  ...
  <div class="container">
    ...
    <div class="row-fluid">
      ...
      <?php include('search_results_courses_sidebar.php'); ?>
    ...
    <ul class="nav nav-tabs no-margin" id="scc-tab">
        ...
        <li class="active tab-width"><a href="search_results_courses.php">Courses</a></li>
      </ul>
      ...
      <div class="wrapper no-margin">
        <ul id="search-results-courses">
          <li>
            ...
            <p><a  id="show-details-course">Show Details</a></p>
        ...
        <p class="p-1em align-center"><a class="align-center">See More....</a></p>
      </div>
    </div>
    </div>
