  ...
  <div class="container">
    ...
    <div class="row-fluid">
      ...
      <div class="span9">
        <div class="wrapper">
          <p class="main-heading">Add New Course</p>          
          <div class="p-1em">
              ...
              <div class="control-group">
                <div class="controls no-margin">
                  <input class="input-xlarge" type="text" id="#" placeholder="Whats the name of your course?">
                </div>
              </div>

              <p class="mb-05em">Description</p>          
              <textarea rows="7" class="input-xxlarge mb-1em" placeholder="Write about your course..."></textarea>
              <hr>
